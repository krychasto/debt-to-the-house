...
const SYNERGY_DEFINITIONS := [
	{
		"id": "ace_engine",
		"name": "Silnik Asów",
		"description": "Asy są mocniejsze. Wartość wysokiego asa +1.",
		"tag": "ace",
		"threshold": 2,
	},
	{
		"id": "blackjack_machine",
		"name": "Maszyna Blackjacka",
		"description": "Blackjack wypłaca więcej. Mnożnik blackjacka +0.25.",
		"tag": "blackjack",
		"threshold": 2,
	},
	{
		"id": "cash_flow",
		"name": "Przepływ Kasy",
		"description": "Zwykłe wygrane płacą lepiej. Mnożnik wygranej +0.1.",
		"tag": "money",
		"threshold": 2,
	},
	{
		"id": "high_roller",
		"name": "Gruba Stawka",
		"description": "Ryzyko rośnie. Dług +10%, ale mnożnik wygranej +0.2.",
		"tag": "risk",
		"threshold": 2,
	},
	{
		"id": "dealer_pressure",
		"name": "Presja na Krupiera",
		"description": "Krupier gra odważniej. Próg zostania krupiera +1.",
		"tag": "dealer",
		"threshold": 2,
	},
]
